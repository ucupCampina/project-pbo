        			...
        			.addGroup(gl_loginFormPanel.createParallelGroup(Alignment.LEADING)
        				.addGroup(gl_loginFormPanel.createSequentialGroup()
        					...
        					.addGroup(gl_loginFormPanel.createParallelGroup(Alignment.TRAILING)
        						...
        						.addGroup(gl_loginFormPanel.createSequentialGroup()
        							.addGroup(gl_loginFormPanel.createParallelGroup(Alignment.TRAILING)
        								.addComponent(passwordField, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 321, Short.MAX_VALUE)
        								.addComponent(idLabel, Alignment.LEADING)
        								.addComponent(idField, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 321, Short.MAX_VALUE)
        								.addComponent(signinButton, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 321, Short.MAX_VALUE)
        								.addComponent(passwordLabel, Alignment.LEADING)
        								.addComponent(passwordSeparator, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 321, Short.MAX_VALUE)
        								.addComponent(idSeparator, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 321, Short.MAX_VALUE)
        ...
        gl_loginFormPanel.setVerticalGroup(
        	gl_loginFormPanel.createParallelGroup(Alignment.LEADING)
        		.addGroup(gl_loginFormPanel.createSequentialGroup()
        			...
        			.addGap(5)
        			.addComponent(idSeparator, GroupLayout.PREFERRED_SIZE, 10, GroupLayout.PREFERRED_SIZE)
        			.addGap(18)
