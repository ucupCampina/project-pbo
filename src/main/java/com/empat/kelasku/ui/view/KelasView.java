...
public class KelasView extends JFrame {
	...
	public KelasView() {
		...
		gl_pnlKelas_1_1_1
				.setHorizontalGroup(gl_pnlKelas_1_1_1.createParallelGroup(Alignment.TRAILING)
						.addGap(0, 141, Short.MAX_VALUE).addGroup(Alignment.LEADING,
								gl_pnlKelas_1_1_1.createSequentialGroup().addContainerGap()
										.addComponent(txtpnLebihLengkap_1, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(ComponentPlacement.RELATED, 16, Short.MAX_VALUE)
										.addComponent(txtpnKelas_1_1_1_1, GroupLayout.PREFERRED_SIZE,
												GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
										.addContainerGap()));
		gl_pnlKelas_1_1_1.setVerticalGroup(
				gl_pnlKelas_1_1_1.createParallelGroup(Alignment.LEADING).addGap(0, 27, Short.MAX_VALUE)
